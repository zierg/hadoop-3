...
public class AdvertisementMapperTest {
    ...
    public void test() throws IOException {
        ...
        new MapDriver<Object, Text, TempAdvertisementDataWritable, IntWritable>()
    ...
    static TempAdvertisementDataWritable EXPECTED_OUTPUT_KEY = new TempAdvertisementDataWritable()
            .setCityId("159")
            .setOsType("Windows");

    static IntWritable EXPECTED_OUTPUT_VALUE = new IntWritable(1);
